...
const std::vector<std::string> CORPUS{
    "corpus/artificl.tar",        // Pathological behavior
    "corpus/calgary.tar",         // English text, Geophysical data, C/LISP/PASCAL, Terminal session
    "corpus/cantrbry.tar",        // English text, C/HTML, Excel spreadsheet, SPARC executable
    "corpus/large.tar",           // E. coli genome, King James bible, CIA world fact book
    "corpus/misc.tar"             // First 1,000,000 digits of pi    
};    
...
int main(int argc, char* argv[]) {
    ...
    std::string filename{std::format("corpus-zlib-l={}-{}.csv", LEVEL, std::chrono::system_clock::now())};
