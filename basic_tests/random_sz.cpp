...
int main(int argc, char* argv[]) {
    ...
    std::string filename{std::format("random-zlib-d={}-eb={}-al={}-ial={}.csv", MODE, EB_VAL, ALGO_VAL, INTERP_ALGO_VAL)};
    ...
    test(file, host, testData, dataName, TRIALS, SZ3::EB(EB_VAL), SZ3::ALGO(ALGO_VAL), SZ3::INTERP_ALGO(INTERP_ALGO_VAL), 1e-6);
